    ...
    <label className="flex flex-col gap-2">
      ...
      <div className="relative">
        <select
          ...
          value={value}
          onChange={onChange}
          className="w-full appearance-none rounded-xl border border-cafe-noir/30 bg-white/50 px-4 py-2.5 pr-10 font-sans text-cafe-noir focus:border-cafe-noir focus:outline-none focus:ring-1 focus:ring-cafe-noir transition-colors [&>option]:text-black"
        >
